              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    readOnly
                    value={`https://ecoshinebd.com${shareProduct.categoryId === "houseware" ? "/houseware" : ""}/products/${shareProduct.id}`}
                  ...
                  <button
                    onClick={() => {
                      const url = `https://ecoshinebd.com${shareProduct.categoryId === "houseware" ? "/houseware" : ""}/products/${shareProduct.id}`;
              ...
              <div className="space-y-1.5 pt-1">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    readOnly
                    value={`https://ecoshinebd.com${shareProduct.categoryId === "houseware" ? "/houseware" : ""}/products/${shareProduct.id}?order=true`}
                  ...
                  <button
                    onClick={() => {
                      const url = `https://ecoshinebd.com${shareProduct.categoryId === "houseware" ? "/houseware" : ""}/products/${shareProduct.id}?order=true`;
                      navigator.clipboard.writeText(url);
                      setCopiedType("order");
                      setTimeout(() => setCopiedType(null), 2500);
                    }}
                    className="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-all flex items-center gap-1.5 shrink-0 shadow-sm"
                  >
                ...
                <p className="text-[11px] text-slate-500 font-medium leading-tight pt-0.5">
                  💡 কাস্টমার ফেসবুকে লিংকটি ক্লিক করলেই সাথে সাথে প্রোডাক্ট পেজে অর্ডার ফর্ম বা পপআপ ওপেন হবে।
                </p>
              </div>
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center gap-3">
                <a
                  href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(
                    `https://ecoshinebd.com${shareProduct.categoryId === "houseware" ? "/houseware" : ""}/products/${shareProduct.id}?order=true`
                  )}`}
                  target="_blank"
